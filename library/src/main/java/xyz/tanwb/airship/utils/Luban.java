...
public class Luban {
    ...
    public static File getPhotoCacheDir(Context context, String cacheName) {
        ...
        Log.e("default disk cache dir is null");
        return null;
    }

    public static Luban getInstance(Context context) {
        if (instance == null) {
    ...
    private void firstCompress(@NonNull File file) {
        ...
        String thumbFilePath = mCacheDir.getAbsolutePath() + File.separator + System.currentTimeMillis();
        long size = 0;
    ...
    private File saveImage(String filePath, Bitmap bitmap, long size) {
        checkNotNull(bitmap, "Luban bitmap cannot be null");

        File result = new File(filePath.substring(0, filePath.lastIndexOf(File.separator)));
