...
class CacheDao<T> extends DataBaseDao<CacheEntity<T>> {
    ...
    public CacheEntity<T> get(String key) {
        String selection = CacheHelper.KEY + BaseConstants.EQUAL + BaseConstants.QUESTION_MARK;
    ...
    public boolean remove(String key) {
        String whereClause = CacheHelper.KEY + BaseConstants.EQUAL + BaseConstants.QUESTION_MARK;
