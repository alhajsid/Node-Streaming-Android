package com.example.streaming.library.okhttp.cache;
...
class CacheHelper extends SQLiteOpenHelper {
    ...
    //四条sql语句
    private static final String SQL_CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY + " VARCHAR, " + LOCAL_EXPIRE + " INTEGER, " + HEAD + " BLOB, " + DATA + " BLOB)";
    ...
    CacheHelper() {
        super(OkHttpManager.getContext(), DB_CACHE_NAME, null, DB_CACHE_VERSION);
    }
