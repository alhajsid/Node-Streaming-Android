package com.example.streaming.library.okhttp.cookie;
...
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore() {
        cookiePrefs = OkHttpManager.getContext().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
        ...
        for (Map.Entry<String, ?> entry : prefsMap.entrySet()) {
            if ((entry.getValue()) != null && !entry.getKey().startsWith(COOKIE_NAME_PREFIX)) {
                ...
                String[] cookieNames = TextUtils.split((String) entry.getValue(), BaseConstants.COMMA);
    ...
    private void saveCookie(HttpUrl url, Cookie cookie, String name) {
        ...
        prefsWriter.putString(url.host(), TextUtils.join(BaseConstants.COMMA, cookies.get(url.host()).keySet()));
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            Log.d("ClassNotFoundException in decodeCookie", e);
        }
        return cookie;
    }
