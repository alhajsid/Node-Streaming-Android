package com.example.streaming.library.okhttp.utils;
...
import com.example.streaming.library.okhttp.request.BaseRequest;
    ...
    public static <T> CacheEntity<T> createCacheEntity(Headers responseHeaders, T data, CacheMode cacheMode, String cacheKey) {
        ...
        if (cacheMode == CacheMode.DEFAULT) {
            ...
            if (!TextUtils.isEmpty(cacheControl)) {
                StringTokenizer tokens = new StringTokenizer(cacheControl, BaseConstants.COMMA);
